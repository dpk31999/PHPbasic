	...
	else
	{
		...
		else
		{
			...
			else
			{
                ...
                $sql = "INSERT INTO messenger.users (username,password,date_created)
                VALUE('$username' , '$password' , '$date_current')";
                $result = mysqli_query($cn,$sql);
                if(!$result){
					
                    echo "Error: " . $sql . "<br>" . mysqli_error($cn) . "<a href='join.php'>Thử lại</a>";
                }
                else{
