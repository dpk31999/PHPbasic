<?php
	if(isset($_SESSION['product'])){
		if($user){
			echo '<div class="tieude">Giỏ hàng của bạn | <span>Xin chào bạn:<strong><em> '.$data_user['tenkhachhang'].'</em></strong></span></div>';
		}else{
...
?>
            ...
            <ul	class="control">
              <p><a href="/bookstore">Tiếp tục mua hàng</a></p>
                <p><a href="?quanly=dangkymoi">Đăng ký mới</a></p>
                <p><a href="?quanly=dangnhap">Bạn đã có tài khoản</a></p>
                <?php
				if($user != '' &&isset($_SESSION['product'])){
				?>
                 <p style="float:right; background:#FF0;text-decoration:none;"><a href="?quanly=hoadon" style="color:#000;margin:5px;">In hóa đơn</a></p>
